...
SWIFT_MODULE_NAMESPACE_PUSH("Mofiler")

SWIFT_CLASS("_TtC7Mofiler16MOGenericManager")
@interface MOGenericManager : NSObject
...
- (void)injectValueWithNewValue:(NSDictionary<NSString *, id> * _Nonnull)newValue expirationDateInMilliseconds:(NSNumber * _Nullable)expirationDateInMilliseconds;
